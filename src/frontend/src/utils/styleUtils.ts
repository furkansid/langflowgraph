...
export const SIDEBAR_CATEGORIES = [
  ...
  { display_name: "Channels", name: "channels", icon: "channels" },
  { display_name: "Experts", name: "experts", icon: "experts" },
  { display_name: "LogicBox", name: "logicbox", icon: "logicbox" },
  { display_name: "Data Store", name: "datastore", icon: "datastore" },
